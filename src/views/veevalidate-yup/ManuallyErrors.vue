...
import { validationExample } from '@/services'

import { useForm, useField } from 'vee-validate'
import { loginSchema } from '@/core/utils'
  ...
  setup () {
    ...
    const onSubmit = handleSubmit(async values => {
      try {
        ...
        const response = await validationExample.login(values as ILoginType) as ILoginResponse
